          ...
          <div className="modal__answers-wrapper">
            ...
            <div className="modal__answers">
              <button
                ...
                onClick={() =>
                  handleNextQuestion(quizData[currentQuestion - 1].answers[0])
                }
              >
              ...
              <button
                className="modal__answer"
                onClick={() =>
                  handleNextQuestion(quizData[currentQuestion - 1].answers[1])
                }
              >
            ...
            <div className="modal__answers">
              <button
                className="modal__answer"
                onClick={() =>
                  handleNextQuestion(quizData[currentQuestion - 1].answers[2])
                }
              >
              ...
              <button
                className="modal__answer"
                onClick={() =>
                  handleNextQuestion(quizData[currentQuestion - 1].answers[3])
                }
              >
